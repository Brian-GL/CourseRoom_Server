...
function Solucion = PolinizacionEvolutiva(Imagen,Plantilla,NumeroDeIteraciones,NumeroDeIndividuos, Minimo, Maximo, Dimension, ParametroDePaso, CriterioDeProbabilidad ,FactorDeAmplificacion,ConstanteDeRecombinacion)
    ...
    for i=1:NumeroDeIndividuos 
        ...
        %Iteramos para cada dimensión con el objetivo de obtener la posición aletoria del individuo:
        for j = 1: Dimension
             %Creamos, para esa dimensión del individuo, un valor aleatorio
             %dentro del rango especificado en los valores Minimo y Maximo dados como parámetros.
             %Sin embargo, debemos de especificar que los valores aleatorios sean enteros (Ya que en la imagen nos posicionamos en índices enteros).
    ...
    for iteracion = 1:NumeroDeIteraciones
        ...
        for i = 1: NumeroDeIndividuos
            ...
            if r < CriterioDeProbabilidad
                ...
                %Mediante la función de penalización, recalcularemos la solución candidata obtenida con anterioridad:
                ...
                if EvaluacionSolucionCandidata > Evaluaciones(i) %Recordando que es un problema de maximización en este caso.
              ...
              %    *Fin Fase De Polinización Global*
                ...
                for j = 1 : NumeroDeIndividuos
                    ...
                    %Mediante la función de penalización, recalcularemos el vector mutado con anterioridad:
    ...
    %Actualizamos el valor de Solución (el valor de la solución óptima a retornar).
